package com.saludencamino.myapplication.view.ecg;
...
import com.saludencamino.myapplication.R;
...
//    private final static int DATA_PRE_SECOND = 530;
    private final static int DATA_PRE_SECOND = 200;
    ...
    public ChartView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        linePaint.setColor(getResources().getColor(R.color.Letras));
...
//        widthSize = Math.round(this.width / gapX);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        Log.e("ChartView", "onSizeChanged: xS = "+xS);
...
//            System.out.println("====>" + singleThreadExecutor.getQueue().size());
            return;
        }
...
//        y = (int) (realMv*gain*xS);
//        y = (int) (mViewHalfHeight + y * 18.3 / 128 * xS / 10 * gain);
        y = (int) (mViewHalfHeight + realMv*xS*gain);
//        Log.e("ChartView", "realMv: "+realMv + " realMv*xS*gain = "+realMv*xS*gain +" y = "+y +" originY = "+originY);
        //判断超出范围
    ...
    private float calcRealMv(int point){
        //y * 18.3 / 128 * xS / 10 * gain
//        return (float) (point * 18.3 / 128 / 10);
