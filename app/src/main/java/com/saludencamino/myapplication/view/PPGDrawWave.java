package com.saludencamino.myapplication.view;

import android.graphics.Canvas;
import android.graphics.Paint;

import com.saludencamino.myapplication.App;
...
public class PPGDrawWave extends DrawWave<Integer> {
    ...
    //定义PPG波的颜色
    private final static int waveColor = App.getInstance().getResources().getColor(R.color.Letras);
    //定义波的线粗
